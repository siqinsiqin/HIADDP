...
class anisodiff2D(object):
    ...
    def __init__(self, num_iter=5, delta_t=0.1, kappa=50, option=2):  # delta  default 1 / 7。kappa 30
...
# image = cv2.imdecode(np.fromfile("D:\\backup\\learning\\DeepLearning\\DL\\segmentation\\baseExpV3\\zhanlian.png", dtype=np.uint8), -1)
# an_filter = anisodiff2D()
# diff_im = an_filter.fit(image)
