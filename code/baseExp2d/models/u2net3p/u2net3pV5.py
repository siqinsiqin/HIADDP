# # -*-coding:utf-8 -*-
# """
# # Time       ：2022/8/24 18:32
# # Author     ：comi
# # version    ：python 3.8
# # Description：
# # todo 优化3+结构，dw卷积，优化u2net,mid channel  // 2
# # todo result,adamw, dice,80.89
# """
#
# import torch
...
# # from models.u2netV.U2netV4 import DRSU7, DRSU6, DRSU5, DRSU4, DRSU4F, DEPTHWISECONV, ConvBNReLU, U2baseblock
#
#
...
#         super(U2net3p6V5, self).__init__()
#         self.sup = sup
...
#         hd5, _ = self.fusion5d(torch.cat((h1_to_hd5, h2_to_hd5, h3_to_hd5, h4_to_hd5, h5_Cat_hd5, hd6_up_hd5), dim=1))
#
...
#         hd4, _ = self.fusion4d(torch.cat((h1_to_hd4, h2_to_hd4, h3_to_hd4, h4_Cat_hd4, hd5_Up_hd4, hd6_Up_hd4), dim=1))
#
...
#         hd3, _ = self.fusion3d(torch.cat((h1_to_hd3, h2_to_hd3, h3_Cat_hd3, hd4_Up_hd3, hd5_Up_hd3, hd6_up_hd3), dim=1))
#
...
#
#     def __init__(self, in_channel=1, n_classes=1, filters=None, sup=False, encoderOnly=False, side=False):
#         super(U2net3p5V5, self).__init__()
#         self.sup = sup
#         self.encoderOnly = encoderOnly
#         self.side = side
#         if filters is None:
...
#         h4_Cat_hd4 = self.h4_Cat_hd4(h4)
#         hd5_Up_hd4 = self.hd5_Up_hd4(hd5, h4_Cat_hd4)
#         hd4, _ = self.fusion4d(torch.cat((h1_to_hd4, h2_to_hd4, h3_to_hd4, h4_Cat_hd4, hd5_Up_hd4), dim=1))
#
#         h1_to_hd3 = self.h1_to_hd3(skip1)
#         h2_to_hd3 = self.h2_to_hd3(skip2)
#         h3_Cat_hd3 = self.h3_Cat_hd3(h3)
#         hd4_Up_hd3 = self.hd4_Up_hd3(hd4, h3_Cat_hd3)
#         hd5_Up_hd3 = self.hd5_Up_hd3(skip5, h3_Cat_hd3)
#         hd3, _ = self.fusion3d(torch.cat((h1_to_hd3, h2_to_hd3, h3_Cat_hd3, hd4_Up_hd3, hd5_Up_hd3), dim=1))
#
#         h1_to_hd2 = self.h1_to_hd2(skip1)
#         h2_cat_hd2 = self.h2_cat_hd2(h2)
#         hd3_up_hd2 = self.hd3_up_hd2(hd3, h2_cat_hd2)
