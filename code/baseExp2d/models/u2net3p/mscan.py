...
class AttentionModule(BaseModule):
    def __init__(self, dim):
        ...
        self.conv0_1 = nn.Conv3d(dim, dim, (1, 7), padding=(0, 3), groups=dim)
        self.conv0_2 = nn.Conv3d(dim, dim, (7, 1), padding=(3, 0), groups=dim)

        self.conv1_1 = nn.Conv3d(dim, dim, (1, 11), padding=(0, 5), groups=dim)
        self.conv1_2 = nn.Conv3d(dim, dim, (11, 1), padding=(5, 0), groups=dim)
