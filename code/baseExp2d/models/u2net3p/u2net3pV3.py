...
# version    ：python 3.8
# Description：
todo 添加checkpoint 时间换空间，修改skip 卷积数为1
"""
...
class Block(nn.Module):
    def __init__(self, in_channel, out_channel, downstep=None, block=None):
        ...
        if block is None:  # UNet 基本块，skip，
            self.blockf = nn.Sequential(nn.Conv3d(in_channel, out_channel, 3, 1, 1),
...
class U2net3p6V3(nn.Module):
    ...
    def forward(self, x):
        ...
        h1_to_hd5 = self.cp(self.h1_to_hd5, h1)
        h2_to_hd5 = self.cp(self.h2_to_hd5, h2)
        h3_to_hd5 = self.cp(self.h3_to_hd5, h3)
        h4_to_hd5 = self.cp(self.h4_to_hd5, h4)
        h5_Cat_hd5 = self.cp(self.h5_Cat_hd5, h5)
        hd6_up_hd5 = self.cp(self.hd6_up_hd5, hd6, h5_Cat_hd5)
        hd5 = self.fusion5d(torch.cat((h1_to_hd5, h2_to_hd5, h3_to_hd5, h4_to_hd5, h5_Cat_hd5, hd6_up_hd5), dim=1))

        h1_to_hd4 = self.cp(self.h1_to_hd4, h1)
        h2_to_hd4 = self.cp(self.h2_to_hd4, h2)
        h3_to_hd4 = self.cp(self.h3_to_hd4, h3)
        h4_Cat_hd4 = self.cp(self.h4_Cat_hd4, h4)
        hd5_Up_hd4 = self.cp(self.hd5_Up_hd4, hd5, h4_Cat_hd4)
        hd6_Up_hd4 = self.cp(self.hd6_Up_hd4, hd6, h4_Cat_hd4)
        hd4 = self.fusion4d(torch.cat((h1_to_hd4, h2_to_hd4, h3_to_hd4, h4_Cat_hd4, hd5_Up_hd4, hd6_Up_hd4), dim=1))

        h1_to_hd3 = self.cp(self.h1_to_hd3, h1)
        h2_to_hd3 = self.cp(self.h2_to_hd3, h2)
        h3_Cat_hd3 = self.cp(self.h3_Cat_hd3, h3)
        hd4_Up_hd3 = self.cp(self.hd4_Up_hd3, hd4, h3_Cat_hd3)
        hd5_Up_hd3 = self.cp(self.hd5_Up_hd3, hd5, h3_Cat_hd3)
        hd6_up_hd3 = self.cp(self.hd6_Up_hd3, hd6, h3_Cat_hd3)
        hd3 = self.fusion3d(torch.cat((h1_to_hd3, h2_to_hd3, h3_Cat_hd3, hd4_Up_hd3, hd5_Up_hd3, hd6_up_hd3), dim=1))

        h1_to_hd2 = self.cp(self.h1_to_hd2, h1)
        h2_cat_hd2 = self.cp(self.h2_cat_hd2, h2)
        hd3_up_hd2 = self.cp(self.hd3_up_hd2, hd3, h2_cat_hd2)
        hd4_up_hd2 = self.cp(self.hd4_up_hd2, hd4, h2_cat_hd2)
        hd5_up_hd2 = self.cp(self.hd5_up_hd2, hd5, h2_cat_hd2)
        hd6_up_hd2 = self.cp(self.hd6_Up_hd2, hd6, h2_cat_hd2)
        hd2 = self.fusion2d(torch.cat((h1_to_hd2, h2_cat_hd2, hd3_up_hd2, hd4_up_hd2, hd5_up_hd2, hd6_up_hd2), dim=1))

        h1_Cat_hd1 = self.cp(self.h1_Cat_hd1, h1)
        hd2_UT_hd1 = self.cp(self.hd2_up_hd1, hd2, h1_Cat_hd1)
        hd3_UT_hd1 = self.cp(self.hd3_up_hd1, hd3, h1_Cat_hd1)
        hd4_UT_hd1 = self.cp(self.hd4_up_hd1, hd4, h1_Cat_hd1)
        hd5_UT_hd1 = self.cp(self.hd5_up_hd1, hd5, h1_Cat_hd1)
        hd5_up_hd1 = self.cp(self.hd6_Up_hd1, hd6, h1_Cat_hd1)
...
class U2net3p5V3(nn.Module):

    def __init__(self, in_channel=1, n_classes=1, filters=None, sup=False, encoderOnly=False, side=False,
                 checkpoint=False):  # v4 增加checkpoint
        super(U2net3p5V3, self).__init__()
        self.sup = sup
        self.encoderOnly = encoderOnly
        self.side = side
        self.checkpoint = checkpoint
    ...
    def forward(self, x):
        ...
        h1_to_hd4 = self.cp(self.h1_to_hd4, h1)  # 采用一小段checkpoint
        h2_to_hd4 = self.cp(self.h2_to_hd4, h2)
        h3_to_hd4 = self.cp(self.h3_to_hd4, h3)
        h4_Cat_hd4 = self.cp(self.h4_Cat_hd4, h4)
        hd5_Up_hd4 = self.cp(self.hd5_Up_hd4, h5, h4_Cat_hd4)
        ...
        h3_Cat_hd3 = self.cp(self.h3_Cat_hd3, h3)
        hd4_Up_hd3 = self.cp(self.hd4_Up_hd3, hd4, h3_Cat_hd3)
        hd5_Up_hd3 = self.cp(self.hd5_Up_hd3, h5, h3_Cat_hd3)
        ...
        hd3_up_hd2 = self.cp(self.hd3_up_hd2, hd3, h2_cat_hd2)
        hd4_up_hd2 = self.cp(self.hd4_up_hd2, hd4, h2_cat_hd2)
        hd5_up_hd2 = self.cp(self.hd5_up_hd2, h5, h2_cat_hd2)
        ...
        hd3_UT_hd1 = self.cp(self.hd3_up_hd1, hd3, h1_Cat_hd1)
        hd4_UT_hd1 = self.cp(self.hd4_up_hd1, hd4, h1_Cat_hd1)
        hd5_UT_hd1 = self.cp(self.hd5_up_hd1, h5, h1_Cat_hd1)
...
if __name__ == '__main__':
    ...
    x = Variable(var)
    model = U2net3p6dc(1, 1, filters=[64, 128, 256, 512, 512], )
