...
class UNet_Nested3d(nn.Module):

    def __init__(self, in_channels=1, n_classes=2, is_deconv=True, is_batchnorm=True, is_ds=False):
        super(UNet_Nested3d, self).__init__()
...
if __name__ == '__main__':
    ...
    x = Variable(torch.rand(3, 1, 64, 64, 64)).cuda()
    model = UNet_Nested3d(1, 1).cuda()
