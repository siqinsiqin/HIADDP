...
from models.models_3d.mipt.ASA.neural_network import SegmentationNetwork
...
if __name__ == '__main__':
    ...
    model = MEDIUMVIT(in_channels=1, out_channels=1, img_size=(SIZE, SIZE, SIZE), norm_name='instance').to('cuda:0')
