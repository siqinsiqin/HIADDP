...
def create_conv(in_channels, out_channels, kernel_size, order, num_groups, padding):
    """
    Create a list of modules with together constitute a thin conv layer with non-linearity
...
class Encoder(nn.Module):
    """
    A thin module from the encoder path consisting of the optional max
...
class Decoder(nn.Module):
    """
    A thin module for decoder path consisting of the upsampling layer
