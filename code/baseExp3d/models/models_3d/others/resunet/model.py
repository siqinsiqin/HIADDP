...
from models.models_3d.others.resunet.buildingblocks import create_encoders, create_decoders, DoubleConv, ExtResNetBlock
from models.models_3d.others.resunet.utils import number_of_features_per_level, get_class
...
class UNet3d(Abstract3DUNet):
    """
    3DUnet model from
    `"ThreeD U-Net: Learning Dense Volumetric Segmentation from Sparse Annotation"
...
class UNet2D(Abstract3DUNet):
    """
    Just a standard twoD Unet. Arises naturally by specifying conv_kernel_size=(1, 3, 3), pool_kernel_size=(1, 2, 2).
    """
