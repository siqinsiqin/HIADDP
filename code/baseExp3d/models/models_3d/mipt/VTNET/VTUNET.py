...
from models.models_3d.mipt.VTNET.neural_network import SegmentationNetwork
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(self.pretrained, str):
            ...
            if self.pretrained2d:
                ...
                torch.load_state_dict(self.pretrained, strict=False)
...
class VTUNet(SegmentationNetwork):
    def __init__(self, pretrain_ckpt="./pretrained_ckpt/swin_tiny_patch4_window7_224_22k.pth", num_classes=3,
                 zero_head=False, embed_dim=48, win_size=7):
        super(VTUNet, self).__init__()
        self.num_classes = num_classes
        self.zero_head = zero_head
        self.pr_path = pretrain_ckpt
        self.embed_dim = embed_dim
        self.win_size = win_size
        self.win_size = (self.win_size, self.win_size, self.win_size)

        self.swin_unet = SwinTransformerSys3D(img_size=(64, 64, 64),
                                              patch_size=(4, 4, 4),
                                              in_chans=1,
    ...
    def load_from(self, pretrain_ckpt):
...
if __name__ == '__main__':
    ...
    model = VTUNet(num_classes=1).cuda()
