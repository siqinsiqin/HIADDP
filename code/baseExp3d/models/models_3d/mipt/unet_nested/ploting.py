...
def plot_kernels(tensor, n_iter, num_cols=20, cmap="gray"):
    ...
    for t1 in t:
        for t2 in t1:
            ...
            ax1 = fig.add_subplot(10, num_cols, i)
            ax1.imshow(t2)
            ax1.axis('off')
            ax1.set_xticklabels([])
            ax1.set_yticklabels([])
    ...
    plt.savefig(
        '/home/wangchengcheng/CV/nnUNet/Plot_Kernal/Kernal_' + str(n_iter - 1) + '_epoch_'
        + str(i), dpi=300)
