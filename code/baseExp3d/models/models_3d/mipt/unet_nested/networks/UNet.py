...
from unet_nested.layers import unetConv2, unetUp
from unet_nested.utils import init_weights, count_param


class UNet(nn.Module):

    def __init__(self, in_channels=1, n_classes=2, feature_scale=4, is_deconv=True, is_batchnorm=True):
