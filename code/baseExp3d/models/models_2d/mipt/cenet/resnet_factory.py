# *coding:utf-8 *
from models.models_2d.mipt.cenet.build_resnet import get_resnet_18, get_resnet_34, get_resnet_50, get_resnet_101, \
    get_resnet_152
...
def get_resnet_backbone(model_name):
    ...
    assert model_name in support_resnet_models, "We just support the following model: {}".format(support_resnet_models)
