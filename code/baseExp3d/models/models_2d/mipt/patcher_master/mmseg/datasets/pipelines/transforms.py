...
class Resize(object):
    ...
    ``img_scale`` can either be a tuple (thin-scale) or a list of tuple
    ...
    def _random_scale(self, results):
        ...
        Otherwise, thin scale will be used.
...
class RandomCrop(object):
    ...
    Args:
        ...
        cat_max_ratio (float): The maximum ratio that thin category could
            occupy.
    """
