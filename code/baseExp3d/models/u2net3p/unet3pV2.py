...
class unetConv3(nn.Module):
    def __init__(self, in_size, out_size, is_batchnorm, n=2, ks=3, stride=1, padding=1):
        ...
        s = stride
        p = padding
        self.resconect = nn.Conv3d(in_size, out_size, kernel_size=3, padding=1)
...
class UNet3PlusV2(nn.Module):
    ...
    def forward(self, inputs):
        ...
        hd2_UT_hd1 = self.hd2_UT_hd1_relu(self.hd2_UT_hd1_bn(self.hd2_UT_hd1_conv(_upsample(hd2, h1_Cat_hd1))))
        hd3_UT_hd1 = self.hd3_UT_hd1_relu(self.hd3_UT_hd1_bn(self.hd3_UT_hd1_conv(_upsample(hd3, h1_Cat_hd1))))
        hd4_UT_hd1 = self.hd4_UT_hd1_relu(self.hd4_UT_hd1_bn(self.hd4_UT_hd1_conv(_upsample(hd4, h1_Cat_hd1))))
        hd5_UT_hd1 = self.hd5_UT_hd1_relu(self.hd5_UT_hd1_bn(self.hd5_UT_hd1_conv((_upsample(hd5, h1_Cat_hd1)))))
