...
# # Output shape: torch.Size([8, 64, 64, 64, 64])
# # Computational complexity:       2.98 GMac
# # Number of parameters:           67.8 k
# Output shape: torch.Size([8, 64, 64, 64, 64])
# Computational complexity:       14.13 GMac
# Number of parameters:           128.0 k
# Output shape: torch.Size([8, 64, 64, 64, 64])
# Computational complexity:       47.24 GMac
# Number of parameters:           611.52 k
class RSU7(nn.Module):  # UNet07DRES(nn.Module):
    ...
    def forward(self, x):
        ...
        return hx1d  # + hxin  # 80.72 不加hxin


# Output shape: torch.Size([8, 64, 64, 64, 64])
# Computational complexity:       2.98 GMac
# Number of parameters:           61.85 k
# Output shape: torch.Size([8, 64, 64, 64, 64])
# Computational complexity:       47.24 GMac
# Number of parameters:           528.38 k
