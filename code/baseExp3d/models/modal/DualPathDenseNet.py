...
from models.modal.basemodel import BaseModel
...
class DualSingleDenseNet(BaseModel):
    ...
    dual-thin-densenet OR Disentangled modalities with early fusion in the paper
    """
...
if __name__ == '__main__':
    ...
    model = DualSingleDenseNet(3, 1).cuda()
    out = model(x)
    print(out.shape)
