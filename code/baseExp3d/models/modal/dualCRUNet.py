...
from models.modal.AttentionRebuild import CASP, Attention
...
from utils.norm import Swish, unetconv3d, CResBlock, conv3d
...
class dualCRUNetv1(nn.Module):

    def __init__(self, deconder='cr', depth=1):
        super(dualCRUNetv1, self).__init__()
        ...
        self.neck_attn = CASP(1024, 64, hwd=4)
        self.f_attn = CASP(512, 32, hwd=8)
        self.t_attn = CASP(256, 16, hwd=16)
        self.s_attn = CASP(128, 8, hwd=32)

        # self.neck_attn = CASP(1024, 32, hwd=4)
        # self.f_attn = CASP(512, 16, hwd=8)
        # self.t_attn = CASP(256, 8, hwd=16)
        # self.s_attn = CASP(128, 4, hwd=32)
        # self.neck_attn = SP(1024, hwd=4)
        # self.f_attn = SP(512, hwd=8)
        # self.t_attn = SP(256, hwd=16, )
        # self.s_attn = SP(128, hwd=32, )
        # #
        # self.neck_attn = CA(1024, depth)
        # self.f_attn = CA(512, depth)
        # self.t_attn = CA(256, depth)
        # self.s_attn = CA(128, depth)
